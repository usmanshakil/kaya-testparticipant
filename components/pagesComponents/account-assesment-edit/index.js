            ...
            <div className="px-8 py-3 ">
              <div className="bg-white h-full px-8 py-12">
                <div className="flex items-center justify-end">
                  <Link href="/account-assesment-save">
                    <a>
                      {' '}
                      <SimpleButton
                ...
                <div className="w-full sm:flex">
                  <div className="sm:w-1/3 w-full pt-4 ">
                    <div className=" rounded-lg ">
                      ...
                      <p className="text-base font-normal   rounded-lg ">
                ...
                <div className="sm:flex sm:flex-wrap  items-center mt-8">
                  <div className="sm:mb-0 mb-2 mr-4">
                    <TypeSelectorBox

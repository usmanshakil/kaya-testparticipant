...
import Leftnav from "../../major-components/sideBar";
    ...
    return (
        ...
        <div className="flex h-full">
            ...
            <MainArea InnerText="Change Password" fontWeight=" font-medium">
                <form onSubmit={event => changePassword(event)} className="py-16 flex flex-col items-center justify-center ">
                    <div className="pt-6">
                    ...
                    <div className="lg:w-2/5 w-3/5 mt-6">
                        {
                            ...
                            </button> : <button type="submit" disabled={loader} className="focus:outline-none rounded-lg text-white py-3 px-5 text-lg bg-theme-blue-color w-full">Change Password</button>
                        }
